...
public class Dosen {
    ...
    public void giveScore(modul2.mobil.Mahasiswa student, int nilai){
    ...
    public int getScore(modul2.mobil.Mahasiswa student){
    ...
    modul2.mobil.Mahasiswa student  = new modul2.mobil.Mahasiswa();
   
    student.setNim("130118383");
    student.setNama("Budi");
   
    modul2.mobil.Dosen instructor = new modul2.mobil.Dosen();
